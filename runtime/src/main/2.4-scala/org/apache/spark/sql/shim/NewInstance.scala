...
object NewInstance5 {
  ...
  def apply(
    ...
    new NewInstance(cls, arguments, propagateNull, dataType, outerPointer)
...
/**
 * inputTypes are ignored for 2.4
 */
object NewInstance6 {
  def apply(cls: Class[_],
    ...
    NewInstance(cls, arguments, propagateNull, dataType, outerPointer)
