...
import org.apache.spark.sql.catalyst.util.QuotingUtils.quoteIfNeeded
...
trait NamedExpression extends Expression {
  ...
  // DBR 17.3
  val FULLY_ORDERED_TAG: org.apache.spark.sql.catalyst.trees.TreeNodeTag[Boolean] =
    org.apache.spark.sql.catalyst.trees.TreeNodeTag[Boolean]("_fullyOrdered")
  val STABLE_RESULT_TAG: org.apache.spark.sql.catalyst.trees.TreeNodeTag[Boolean] =
    org.apache.spark.sql.catalyst.trees.TreeNodeTag[Boolean]("_stableResult")
