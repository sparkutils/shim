 ...
 */
case class ExpressionLookup(attributesUsed: Names.Identifiers = Set.empty, unknownSparkFunctions: Names.Identifiers = Set.empty, lambdas: Set[Id] = Set.empty, sparkFunctions: Set[String] = Set.empty)
